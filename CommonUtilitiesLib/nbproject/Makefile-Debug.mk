...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${AVS_ROOT}/lib/libCommonUtilitiesLib.a

${AVS_ROOT}/lib/libCommonUtilitiesLib.a: ${OBJECTFILES}
	${MKDIR} -p ${AVS_ROOT}/lib
	${RM} ${AVS_ROOT}/lib/libCommonUtilitiesLib.a
	${AR} -rv ${AVS_ROOT}/lib/libCommonUtilitiesLib.a ${OBJECTFILES} 
	$(RANLIB) ${AVS_ROOT}/lib/libCommonUtilitiesLib.a
