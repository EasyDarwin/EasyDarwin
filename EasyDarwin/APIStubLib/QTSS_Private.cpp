...
const char*	Easy_StartHLSSession(const char* inSessionName, const char* inURL)
{
	return (const char*)(sCallbacks->addr [kStartHLSSessionCallback]) (inSessionName, inURL);
}
