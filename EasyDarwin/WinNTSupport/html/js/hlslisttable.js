...
function OutputHtml(PageCount, type, json) {
	...
	if (type == 1) {
		...
		var html = "<div class=\"panel-body no-padding\" ><table class=\"footable table table-stripped toggle-arrow-tiny\"><thead><tr><th>Index</th><th>Name</th><th>Source</th><th>Url</th><th>Bitrate(KBps)</th><th>Option</th></tr></thead><tbody>";
