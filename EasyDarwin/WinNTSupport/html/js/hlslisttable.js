...
//type=1时表示hls直播列表页面
//++++++++++++++++++++
function OutputHtml(PageCount,type){
	...
	if(type==1)
	{
		...
		{
			html+="<tr><td>"+i+"</td><td>"+siteList.EasyDarwin.Body.Sessions[i].name+"</td><td>"+siteList.EasyDarwin.Body.Sessions[i].source+"</td><td>"+siteList.EasyDarwin.Body.Sessions[i].url+"</td><td>"+siteList.EasyDarwin.Body.Sessions[i].Bitrate+"</td><td>Play</td></tr>"
		}
