...
#ifndef __BaseRequestInterface_H__
#define __BaseRequestInterface_H__
...
class BaseRequestInterface : public QTSSDictionary
{
    public:
        ...
        //CONSTRUCTOR:
        BaseRequestInterface(BaseSessionInterface *session);
        virtual ~BaseRequestInterface()
        ...
        // Reads data off the stream. Same behavior as calling BaseSessionInterface::Read
        virtual QTSS_Error Read(void* ioBuffer, UInt32 inLength, UInt32* outLenRead)
            { return fSession->Read(ioBuffer, inLength, outLenRead); }
            
        // Requests an event. Same behavior as calling BaseSessionInterface::RequestEvent
        ...
        BaseSessionInterface*       GetSession()         { return fSession; }
...
#endif // __BaseRequestInterface_H__
