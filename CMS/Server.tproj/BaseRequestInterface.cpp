...
*/
/*
    File:       BaseRequestInterface.cp

    Contains:   Implementation of class defined in BaseRequestInterface.h
*/
...
char        BaseRequestInterface::sPremadeHeader[kStaticHeaderSizeInBytes];
StrPtrLen   BaseRequestInterface::sPremadeHeaderPtr(sPremadeHeader, kStaticHeaderSizeInBytes);

char        BaseRequestInterface::sPremadeNoHeader[kStaticHeaderSizeInBytes];
StrPtrLen   BaseRequestInterface::sPremadeNoHeaderPtr(sPremadeNoHeader, kStaticHeaderSizeInBytes);


StrPtrLen   BaseRequestInterface::sColonSpace(": ", 2);

QTSSAttrInfoDict::AttrInfo  BaseRequestInterface::sAttributes[] =
...
void  BaseRequestInterface::Initialize(void)
{
...
BaseRequestInterface::BaseRequestInterface(BaseSessionInterface *session)
       ...
       
{
    ...
    fStreamRef = this;
    BaseRequestStream* input = session->GetInputStream();
    ...
    fMovieFolderPtr = '\0'/*QTSServerInterface::GetServer()->GetPrefs()->GetMovieFolder(fMovieFolderPtr, &pathLen)*/;
...
void BaseRequestInterface::AppendHeader(QTSS_RTSPHeader inHeader, StrPtrLen* inValue)
{
...
void BaseRequestInterface::PutStatusLine(StringFormatter* putStream, QTSS_RTSPStatusCode status,
...
void BaseRequestInterface::AppendContentLength(UInt32 contentLength)
{
    if (!fStandardHeadersWritten)
        this->WriteStandardHeaders();
...
void BaseRequestInterface::AppendDateAndExpires()
{
    if (!fStandardHeadersWritten)
        this->WriteStandardHeaders();
...
void BaseRequestInterface::AppendSessionHeaderWithTimeout( StrPtrLen* inSessionID, StrPtrLen* inTimeout )
{
...
void BaseRequestInterface::PutTransportStripped(StrPtrLen &fullTransportHeader, StrPtrLen &fieldToStrip)
{
...
void BaseRequestInterface::AppendTransportHeader(StrPtrLen* serverPortA,
...
void BaseRequestInterface::AppendContentBaseHeader(StrPtrLen* theURL)
{
    if (!fStandardHeadersWritten)
        this->WriteStandardHeaders();
...
void BaseRequestInterface::AppendRetransmitHeader(UInt32 inAckTimeout)
{
...
void BaseRequestInterface::AppendRTPInfoHeader(QTSS_RTSPHeader inHeader,
...
{
    BaseRequestInterface* theRequest = (BaseRequestInterface*)this;
...
void BaseRequestInterface::WriteStandardHeaders()
{
...
QTSS_Error
BaseRequestInterface::Write(void* inBuffer, UInt32 inLength, UInt32* outLenWritten, UInt32 /*inFlags*/)
{
...
QTSS_Error
BaseRequestInterface::WriteV(iovec* inVec, UInt32 inNumVectors, UInt32 inTotalLength, UInt32* outLenWritten)
{
    (void)fOutputStream->WriteV(inVec, inNumVectors, inTotalLength, NULL, BaseResponseStream::kAlwaysBuffer);
    if (outLenWritten != NULL)
...
void* BaseRequestInterface::GetAbsTruncatedPath(QTSSDictionary* inRequest, UInt32* /*outLen*/)
{
    // This function gets called only once
	
    BaseRequestInterface* theRequest = (BaseRequestInterface*)inRequest;
...
void* BaseRequestInterface::GetTruncatedPath(QTSSDictionary* inRequest, UInt32* /*outLen*/)
{
...
void* BaseRequestInterface::GetFileName(QTSSDictionary* inRequest, UInt32* /*outLen*/)
{
    // This function always gets called
...
void* BaseRequestInterface::GetFileDigit(QTSSDictionary* inRequest, UInt32* /*outLen*/)
{
    // This function always gets called
...
void* BaseRequestInterface::GetRealStatusCode(QTSSDictionary* inRequest, UInt32* outLen)
{
    // Set the fRealStatusCode variable based on the current fStatusCode.
	// This function always gets called
    BaseRequestInterface* theReq = (BaseRequestInterface*)inRequest;
    theReq->fRealStatusCode = RTSPProtocol::GetStatusCode(theReq->fStatus);
    *outLen = sizeof(UInt32);
    return &theReq->fRealStatusCode;
}

void* BaseRequestInterface::GetLocalPath(QTSSDictionary* inRequest, UInt32* outLen)
{
	// This function always gets called	
	BaseRequestInterface* theRequest = (BaseRequestInterface*)inRequest;
	...
	if (theRequest->GetMethod() == qtssSetupMethod)
	{
		...
		BaseRequestInterface::GetTruncatedPath(inRequest, outLen);
	}
...
void* BaseRequestInterface::GetAuthDigestResponse(QTSSDictionary* inRequest, UInt32* )
{
	BaseRequestInterface* theRequest = (BaseRequestInterface*)inRequest;
