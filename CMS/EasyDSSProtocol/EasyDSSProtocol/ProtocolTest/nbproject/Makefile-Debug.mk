...
${OBJECTDIR}/ProtocolTest.o: ProtocolTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../include/EasyDSSProtocol -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProtocolTest.o ProtocolTest.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../include/EasyDSSProtocol -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
