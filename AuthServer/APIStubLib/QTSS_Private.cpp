...
// Http ROUTINES
QTSS_Error QTSS_SendHttpPacket(QTSS_HttpSessionObject inSession, char* inValue, UInt32 inValueLen, Bool16 connectionClose)
{
    return (sCallbacks->addr [kSendHttpPacketCallback]) (inSession,inValue,inValueLen,connectionClose);       
}
...
{
    return (sCallbacks->addr [kSignalStreamCallback]) (inStream,inEventMask);       
}
