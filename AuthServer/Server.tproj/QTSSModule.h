...
class QTSSModule : public QTSSDictionary, public Task
{
    public:
		...
		kRereadPrefsRole =     		3,
		kStateChangeRole =    		4,
		kTimedIntervalRole = 		5,
		kHttpFilterRole =        		6,
		kHttpRouteRole =       		7,
		kHttpPreProcessorRole =	8,
		kHttpRequestRole =            	9,
		kHttpPostProcessorRole =  	10,
		kHttpSessionClosingRole = 	11,
		kOpenFilePreProcessRole = 12,
		kOpenFileRole =             	13,
		kAdviseFileRole =           	14,
		kReadFileRole =             	15,
		kCloseFileRole =            	16,
    ...
    private:
        ...
        static Bool16       sHasHttpRequestModule;
