...
Bool16  QTSSModule::sHasHttpRequestModule = false;
...
{   
           ...
           "HttpFilterRole"           ,
           "HttpRouteRole"            ,
           "HttpPreProcessorRole"     ,
           "HttpRequestRole"          ,
           "HttpPostProcessorRole"    ,
           "HttpSessionClosingRole"   ,
...
{   
    switch (apiRole)
    {
        ...
        case QTSS_HttpFilter_Role:          return kHttpFilterRole          ;
        case QTSS_HttpRoute_Role:           return kHttpRouteRole           ;
        case QTSS_HttpPreProcessor_Role:         return kHttpPreProcessorRole         ;
        case QTSS_HttpRequest_Role:         return kHttpRequestRole         ;		
        case QTSS_HttpPostProcessor_Role:   return kHttpPostProcessorRole   ;
        case QTSS_HttpSessionClosing_Role:  return kHttpSessionClosingRole  ;
...
QTSS_Error  QTSSModule::AddRole(QTSS_Role inRole)
{
    ...
    if ((inRole == QTSS_HttpRequest_Role) && (sHasHttpRequestModule))
   ...
   fRoleArray[arrayID] = true;
    ...
    if (inRole == QTSS_HttpRequest_Role)
        sHasHttpRequestModule = true;
