...
#if __MacOSX__
StrPtrLen               QTSServerInterface::sServerNameStr("HTTP");
#else
StrPtrLen               QTSServerInterface::sServerNameStr("HTTP");
#endif
...
{   /*fields:   fAttrName, fFuncPtr, fAttrDataType, fAttrPermission */
    ...
    /* 6  */ { "qtssSvrServerPorts",              NULL,   qtssAttrDataTypeUInt16,     qtssAttrModeRead },
    /* 7  */ { "qtssSvrServerHeader",       NULL,   qtssAttrDataTypeCharArray,  qtssAttrModeRead | qtssAttrModePreempSafe },
    ...
    /* 23  */ { "qtssSvrServerComment",     NULL,   qtssAttrDataTypeCharArray,  qtssAttrModeRead | qtssAttrModePreempSafe },
    /* 24  */ { "qtssSvrNumThreads",            NULL,   qtssAttrDataTypeUInt32,     qtssAttrModeRead | qtssAttrModePreempSafe }
};
    ...
    fNumThreads(0)
{
    ...
    this->SetVal(qtssSvrServerHeader,   sServerHeaderPtr.Ptr,       sServerHeaderPtr.Len);
    ...
    this->SetVal(qtssSvrServerComment,  sServerCommentStr.Ptr,  sServerCommentStr.Len);
