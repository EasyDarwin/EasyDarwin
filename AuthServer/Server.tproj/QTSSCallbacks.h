...
class QTSSCallbacks
{
    public:
        ...
        // HTTP ROUTINES
	 static QTSS_Error	 QTSS_SendHttpPacket(QTSS_HttpSessionObject inSession, char* inValue, UInt32 inValueLen, Bool16 connectionClose = false);
	 ...
	 // FILE SYSTEM ROUTINES
        ...
        static QTSS_Error   QTSS_SignalStream(QTSS_StreamRef inStream,QTSS_EventType inEventMask);
