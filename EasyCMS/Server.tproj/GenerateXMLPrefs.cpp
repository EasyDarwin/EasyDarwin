...
static const PrefConversionInfo kPrefs[] =
{
    ...
    /* 14 */ { "redis_ip_addr",							NULL,                   qtssAttrDataTypeCharArray },
	/* 15 */ { "redis_port",							NULL,                   qtssAttrDataTypeUInt16 },
    /* 16 */ { "snap_local_path",						NULL,                   qtssAttrDataTypeCharArray },
    /* 17 */ { "snap_web_path",							NULL,                   qtssAttrDataTypeCharArray },
    /* 18 */ { "auto_start",                            NULL,                   qtssAttrDataTypeBool16 },
    /* 19 */ { "MSG_debug_printfs",						NULL,                   qtssAttrDataTypeBool16 },
    /* 20 */ { "enable_monitor_stats_file",             NULL,                   qtssAttrDataTypeBool16 },
    /* 21 */ { "monitor_stats_file_interval_seconds",   NULL,                   qtssAttrDataTypeUInt32 },
    /* 22 */ { "monitor_stats_file_name",               NULL,                   qtssAttrDataTypeCharArray },
	/* 23 */ { "run_num_threads",                       NULL,                   qtssAttrDataTypeUInt32 },
	/* 24 */ { "pid_file",								NULL,					qtssAttrDataTypeCharArray },
    /* 25 */ { "force_logs_close_on_write",             NULL,                   qtssAttrDataTypeBool16 },
	/* 26 */ { "monitor_lan_port",						NULL,					qtssAttrDataTypeUInt16 },
    /* 27 */ { "monitor_wan_port",						NULL,					qtssAttrDataTypeUInt16 },
    /* 28 */ { "monitor_lan_ip",						NULL,                   qtssAttrDataTypeCharArray },
    /* 29 */ { "monitor_wan_ip",						NULL,                   qtssAttrDataTypeCharArray },
    /* 30 */ { "run_num_msg_threads",					NULL,					qtssAttrDataTypeUInt32 },
