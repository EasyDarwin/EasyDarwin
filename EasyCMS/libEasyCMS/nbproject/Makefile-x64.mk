...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_CONF}/libEasyCMS.a

${CND_CONF}/libEasyCMS.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_CONF}
	${RM} ${CND_CONF}/libEasyCMS.a
	${AR} -rv ${CND_CONF}/libEasyCMS.a ${OBJECTFILES} 
	$(RANLIB) ${CND_CONF}/libEasyCMS.a
