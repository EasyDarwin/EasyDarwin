...
${OBJECTDIR}/_ext/b9fc5c32/HTTPProtocol.o: ../HTTPUtilitiesLib/HTTPProtocol.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b9fc5c32/HTTPProtocol.o ../HTTPUtilitiesLib/HTTPProtocol.cpp

${OBJECTDIR}/_ext/b9fc5c32/HTTPRequest.o: ../HTTPUtilitiesLib/HTTPRequest.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/b9fc5c32
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b9fc5c32/HTTPRequest.o ../HTTPUtilitiesLib/HTTPRequest.cpp

${OBJECTDIR}/_ext/b9fc5c32/HTTPRequestStream.o: ../HTTPUtilitiesLib/HTTPRequestStream.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/b9fc5c32
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b9fc5c32/HTTPRequestStream.o ../HTTPUtilitiesLib/HTTPRequestStream.cpp

${OBJECTDIR}/_ext/b9fc5c32/HTTPResponseStream.o: ../HTTPUtilitiesLib/HTTPResponseStream.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/b9fc5c32
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b9fc5c32/HTTPResponseStream.o ../HTTPUtilitiesLib/HTTPResponseStream.cpp
...
${OBJECTDIR}/APIModules/EasyCMSModule/EasyCMSModule.o: APIModules/EasyCMSModule/EasyCMSModule.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/APIModules/EasyCMSModule/EasyCMSModule.o APIModules/EasyCMSModule/EasyCMSModule.cpp

${OBJECTDIR}/APIModules/EasyCMSModule/EasyCMSSession.o: APIModules/EasyCMSModule/EasyCMSSession.cpp 
	${MKDIR} -p ${OBJECTDIR}/APIModules/EasyCMSModule
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/APIModules/EasyCMSModule/EasyCMSSession.o APIModules/EasyCMSModule/EasyCMSSession.cpp
...
${OBJECTDIR}/APIModules/EasyCameraModule/EasyCameraModule.o: APIModules/EasyCameraModule/EasyCameraModule.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/APIModules/EasyCameraModule/EasyCameraModule.o APIModules/EasyCameraModule/EasyCameraModule.cpp

${OBJECTDIR}/APIModules/EasyCameraModule/EasyCameraSource.o: APIModules/EasyCameraModule/EasyCameraSource.cpp 
	${MKDIR} -p ${OBJECTDIR}/APIModules/EasyCameraModule
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/APIModules/EasyCameraModule/EasyCameraSource.o APIModules/EasyCameraModule/EasyCameraSource.cpp
